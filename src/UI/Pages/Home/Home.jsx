...
import {
    ...
    Accordion, AccordionItem, AccordionButton, AccordionPanel, AccordionIcon, TableContainer, Table, Thead, Tr, Th, Tbody, Td, Stat,
    StatLabel,
    StatArrow,
    Badge,
    Tfoot,
    ...
    for (let index = 0; index < amount; index++) {
        cards.push(
            ...
            <Tr>
                ...
                <Td><Progress value={Math.round(Math.random() * (100 - 75) + 75)} /> </Td>
                <Td isNumeric><Stat>
                    <StatLabel>
                        {Math.round(Math.random()) ? <StatArrow type='increase' /> : <StatArrow type='decrease' />}
