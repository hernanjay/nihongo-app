...
function KanaCards({ totalItems, kana, index, setKanaAnswered }) {
    ...
    useEffect(() => {
        if (isCorrect || showAnswer) {
            setKanaAnswered((prevKanaAnswered) => [...prevKanaAnswered, true]);
        }
            ...
            <CardBody>
                ...
                <Input
                    ...
                    onFocus={() => {
                        setIsFocused.on;
                        const elem = document.getElementById(
                            `KanaCardsInput${index}`
                        );
                        if (index + 1 < totalItems) {
                            scrollTo(
                                document.getElementById("kanaPageScroll"),
                                {
                                    top:
