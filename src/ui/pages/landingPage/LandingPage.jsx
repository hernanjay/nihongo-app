      ...
      >
        ...
        <Container mt="1.5em" minW="90vw" minH="120vh">
          <Tabs>
            ...
            <Grid templateColumns="repeat(3, 1fr)" gap={5} mt="2.5em">
              <GridItem colSpan={1}>
                {sample.map((obj) => {
                  return (
                    <Card bg={bg} borderRadius="lg" mb="1.5em">
                      <CardBody>
                        <HStack>
                          <Spacer />
              ...
              <GridItem colSpan={2}>
                <Container px="2.5em" minW="90%" bg={bg} rounded="lg" h="100vh">
                  <HStack>
                    <Tag
                      bg={bg}
                      my="2.5em"
                      ...
                      p="1em"
                    >
                      <TagLabel fontSize="3.5em">{sample[0].kanji}</TagLabel>
                    </Tag>
                    <Box ml="1em">
                      <Text>Reading:</Text>
                    ...
                    {sample.map((val) => {
                      return (
                        <ListItem>
                          ...
                          <Text my="0.25em" color="gray.400">
                            Sed ut perspiciatis, unde omnis iste natus error sit
                            voluptatem accusantium doloremque laudantium,
                          </Text>
                          <Divider borderColor={border} mb="1.5em" />
                        </ListItem>
                      );
                    })}
                  </UnorderedList>
